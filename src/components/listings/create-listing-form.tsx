  ...
  const onSubmit = async (data: CreateListingInput) => {
    ...
    try {
      ...
      if (result.listingSlug) {
        router.push(`/listings/${result.listingSlug}`);
      } else {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Select onValueChange={(val) => { if (val) setValue("category", val as CreateListingInput["category"]); }}>
      ...
      {/* Face Value & Asking Price — side by side */}
      ...
      <div className="space-y-2">
        ...
        <Textarea
          id="description"
          placeholder="Any extra details (e.g. usage restrictions, where it works...)"
          rows={3}
